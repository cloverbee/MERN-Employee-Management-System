...
import {getDetail, saveEditedToUserList, getManager, changeDatePickerDate} from '../../redux/actions';
...
class Edit extends React.Component {
  ...
  onDateChange = (e) => {
      ...
      this.props.getDate(moment(e).format(dateFormat));
  };
  handleChange = info => {
              ...
              <Form.Item label="Start Date"  >
                {getFieldDecorator('datepicker', config)(
                  <DatePicker   format={dateFormat} onChange = {date => this.onDateChange(date)} /*open={this.state.endOpen} onOpenChange={this.handleEndOpenChange}*/
                    value = {(this.props.datePickerDate!=undefined)? moment(this.props.datePickerDate.data):moment(this.props.userDetail.data.startdate)}
                      //moment(this.props.userDetail.data.startdate, dateFormat)
                    defaultPickerValue = { moment(this.props.userDetail.data.startdate, dateFormat)}
                    {...console.log('this.props.datePicker',this.props.datePickerDate)}
                  />
...
const mapStateToProps = state => {
  return {
    ...
    datePickerDate: state.datePicker,
  };
};
...
const mapDispatchToProps = dispatch => {
  return {
      ...
      getDate:(newdate) =>{
        dispatch(changeDatePickerDate(newdate));
      }
  };
};
